...
namespace Robohome.Kinect.XnaStream
{
    ...
    public class ColorStreamRenderer : Object2D
    {
      ...
      //  private BinaryFormatter binaryFormatter = new BinaryFormatter();
        ...
        // StandardOutput.BaseStream = a stream used to read the output of the application, not usable for your case. –  o.k.w Oct 30 '09 at 0:46
       // ANNIE private StreamWriter dataStream = new StreamWriter(Console.OpenStandardOutput());
            ...
            : base(game)
        {
            ...
            try
            {
                // new BinaryWriter(File.Create("kinectdata.rgb"));
                // this works, but only if you redirect stdout
                this.binWriter = new BinaryWriter(File.Create("vsstudioout.raw"));
                    // works if you redirect, but is slower by factor of 20 new BinaryWriter(Console.OpenStandardOutput(), Console.OutputEncoding);
            }
        ...
        public override void Initialize()
        {
            ...
            // ANNIE
          //  dataStream.AutoFlush = true;    // voodoo courtesy http://stackoverflow.com/questions/1647349/write-binary-data-to-stdout-in-c
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            using (var frame = this.Chooser.Sensor.ColorStream.OpenNextFrame(0))
            {
                ...
                // ANNIE
          //      dataStream.BaseStream.Write(this.colorData, 0 , this.colorData.Length);

                // Annie sez it's here, but how the heck do I export it?
            //   binaryFormatter.Serialize(dataStream.BaseStream, this.colorData);     
     
                for(int ii = 0 ; ii < this.colorData.Length ; ii++) {
                    this.binWriter.Write(this.colorData[ii]);
                }
